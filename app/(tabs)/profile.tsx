    ...
    >
      <View style={[styles.hero, { backgroundColor: surface }]}>
        <View style={styles.avatar}>
          <AppText style={styles.avatarText}>JT</AppText>
        </View>
        <AppText variant="title" style={styles.name}>Julia Teste</AppText>
        <AppText style={[styles.meta, { color: icon }]}>20 anos • Sistemas de Informacao • UNOCHAPECO</AppText>
      ...
      <View style={[styles.section, { backgroundColor: surface }]}>
        ...
        <AppText style={[styles.sectionText, { color: text }]}>
          Curto tecnologia, esportes e cafe. Buscando conexoes reais com pessoas da UNOCHAPECO.
        </AppText>
      ...
      <View style={[styles.section, { backgroundColor: surface }]}>
        ...
        <View style={styles.chipsRow}>
          {['Tecnologia', 'Academia', 'Cinema', 'Cafe', 'Musica'].map((interest) => (
      ...
      <View style={[styles.section, { backgroundColor: surface }]}>
        ...
        <View style={styles.preferenceRow}>
          ...
          <AppText style={[styles.preferenceValue, { color: icon }]}>18 - 24</AppText>
        </View>
        <View style={styles.preferenceRow}>
          <AppText style={styles.preferenceLabel}>Distancia maxima</AppText>
          <AppText style={[styles.preferenceValue, { color: icon }]}>15 km</AppText>
        </View>
        <View style={styles.preferenceRow}>
      ...
      <View style={[styles.section, { backgroundColor: surface }]}>
        ...
        <View style={styles.preferenceRow}>
          ...
          <AppText style={[styles.preferenceValue, { color: icon }]}>@unochapeco.edu.br</AppText>
        </View>
        <View style={styles.preferenceRow}>
      ...
      <Button
        ...
        onPress={() => Alert.alert('Pronto', 'Dados salvos localmente nesta versao inicial.')}
